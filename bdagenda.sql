...
-- Agregamos las restricciones de PRIMARY KEY y FOREIGN KEY después de la creación de las tablas
-- utilizando ALTER TABLE

-- Para la tabla distrito
ALTER TABLE distrito ADD CONSTRAINT distrito_codigodis_pk PRIMARY KEY (codigodis);

-- Para la tabla agenda
ALTER TABLE agenda ADD CONSTRAINT agenda_codigoper_pk PRIMARY KEY (codigoper);
ALTER TABLE agenda ADD CONSTRAINT agenda_distrito_fk FOREIGN KEY (distrito) REFERENCES distrito(codigodis);
